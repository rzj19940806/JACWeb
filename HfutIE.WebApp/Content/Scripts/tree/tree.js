...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        var dfop =
            {
                 ...
                 */
                cbiconpath: RootPath() + "/Content/Scripts/tree/Images/icons/",
                icons: ["checkbox_0.gif", "checkbox_1.gif", "checkbox_1.gif"],
                /**
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            ht.push("<div id='", id, "_", nid, "' tpath='", path, "' unselectable='on' title='", nd.title, "'");
            var cs = [];
            ...
            var _img = "<img class='bbit-tree-node-icon' src='" + dfop.cbiconpath + "s.gif'/>";
            if (nd.img != undefined) {
                _img = "<img style='vertical-align: middle;width:16px;height:16px;padding-bottom:2px;padding-right:2px;' src='" + RootPath() + nd.img + "'/>";
            }
            ht.push(_img);
            //checkbox
