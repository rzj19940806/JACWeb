...
namespace HfutIE.WebApp.Controllers
{
    ...
    public class UtilityController : Controller
    {
        ...
        public void GetDeriveExcel(string ExportField)
        {
            ...
            //string JsonColumn = GZipHelper.Uncompress(DeriveExcel.cookieColumn);
            //string JsonData = GZipHelper.Uncompress(DeriveExcel.cookieData);
            //string JsonFooter = GZipHelper.Uncompress(DeriveExcel.cookieFooter);
            //string JsonName = GZipHelper.Uncompress(DeriveExcel.cookieName);
