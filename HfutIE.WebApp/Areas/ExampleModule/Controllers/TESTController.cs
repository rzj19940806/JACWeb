...
namespace HfutIE.WebApp.Areas.ExampleModule.Controllers
{
    public class TESTController : PublicController<POOrder>
    {
        ...
        /// <returns></returns>
        public ActionResult GetOrderList(string BillNo, string StartTime, string EndTime, string taskid, JqGridParam jqgridparam)
        {
            try
            {
                Stopwatch watch = CommonHelper.TimerStart();
                List<POOrder> ListData = poorderbll.GetOrderList(BillNo, StartTime, EndTime, taskid, jqgridparam);
                var JsonData = new
                {
        ...
        public ActionResult SubmitOrderForm(string KeyValue, POOrder entity, string POOrderEntryJson)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(KeyValue))
                {
                    ...
                    entity.Amount = POOrderEntryList.Sum<POOrderEntry>(m => CommonHelper.GetDecimal(m.PriceAmount)).ToString();
