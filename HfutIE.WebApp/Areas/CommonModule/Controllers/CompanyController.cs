    ...
    public class CompanyController : PublicController<Base_Company>
    {
        ...
        public ActionResult DeleteCompany(string KeyValue)
        {
            try
            {
                var Message = "删除失败。";
                int IsOk = 0;
                int DepartmentCount = Convert.ToInt32(DataFactory.Database().FindCount<Base_Department>("CompanyId", KeyValue));
        ...
        public virtual ActionResult SubmitCompanyForm(Base_Company entity, string KeyValue, string BuildFormJson)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Base_DataScopePermissionBll.Instance.AddScopeDefault(ModuleId, ManageProvider.Provider.Current().UserId, "0", entity.CompanyId, isOpenTrans);
