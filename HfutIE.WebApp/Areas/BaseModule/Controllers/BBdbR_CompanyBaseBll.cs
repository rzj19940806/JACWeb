...
namespace HfutIE.Business
{
    ...
    public class BBdbR_CompanyBaseBll : RepositoryFactory<BBdbR_CompanyBase>
    {
        ...
        public List<BBdbR_CompanyBase> GetPageList(JqGridParam jqgridparam) //===复制时需要修改===
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<BBdbR_CompanyBase> GetPlanList()
        {
        ...
        public BBdbR_CompanyBase GetPlanList1(string KeyValue)
        {
            ...
            //{
            //    string sql = "select * from BBdbR_WorkshopBase where WorkshopId='" + dt[i].WorkshopId + "'";
            //    DataTable dt1 = Repository().FindTableBySql(sql.ToString());
            //    if (dt1.Rows.Count > 0)
            //    {
            //        dt[i].WorkshopId = dt1.Rows[0]["WorkshopNm"].ToString();
            //    }
            //}
