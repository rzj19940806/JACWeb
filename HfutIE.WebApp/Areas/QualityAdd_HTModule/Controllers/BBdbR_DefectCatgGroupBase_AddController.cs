    ...
    public class BBdbR_DefectCatgGroupBase_AddController : PublicController<BBdbR_DefectCatgGroupBase_Add>
    {
        ...
        public ActionResult GridListJson(string sort, string areaId, string DefectCatgGroupCd, string DefectCatgGroupNm, JqGridParam jqgridparam)
        {
            try
            {
                ...
                strSql.Append(@"select a.*,b.DefectCatgCd,b.DefectCatgNm from BBdbR_DefectCatgGroupBase_Add a left join BBdbR_DefectCatgBase_Add b on a.DefectCatgId = b.DefectCatgId where a.Enabled =1 and b.Enabled =1 and b.type='CH'");
        ...
        public ActionResult GetExcel_Data(string sort, string areaId, string DefectCatgGroupCd, string DefectCatgGroupNm, JqGridParam jqgridparam)
        {
            try
            {
                ...
                StringBuilder strSql = new StringBuilder();
                strSql.Append(@"select a.DefectCatgGroupCd,a.DefectCatgGroupNm,b.DefectCatgNm,a.Dsc,a.CreTm,a.CreNm,a.MdfTm,a.MdfNm,a.Rem from BBdbR_DefectCatgGroupBase_Add a left join BBdbR_DefectCatgBase_Add b on a.DefectCatgId = b.DefectCatgId where a.Enabled =1 and b.Enabled =1  and b.type='CH'");
                if (areaId != "all" && areaId != "undefined"&& areaId!="")
                {
                    strSql.Append(" and a.DefectCatgId = '" + areaId + "' ");
                }
        ...
        public ActionResult GetDefectCatgList()
        {
            try
            {
                #region 
                StringBuilder strSql = new StringBuilder();
                strSql.Append(@"select * from BBdbR_DefectCatgBase_Add where Enabled =1  and type='CH' order by DefectCatgNm");
                DataTable dt = DataFactory.Database().FindTableBySql(strSql.ToString(), false);
                var JsonData = new
                {
                    rows = dt,
