...
namespace HfutIE.DataAccess
{
    ...
    public interface IDatabase : IDisposable
    {
        ...
        DataTable FindTableTop<T>(int Top, string propertyName, string propertyValue) where T : new();
        ...
        DataTable FindTable<T>(string propertyName, string propertyValue) where T : new();
