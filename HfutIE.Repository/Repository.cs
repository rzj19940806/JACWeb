...
namespace HfutIE.Repository
{
    ...
    public class Repository<T> : IRepository<T> where T : new()
    {
        ...
        {
            return DataFactory.Database().Update(tableName, ht, propertyName);
        }
        /// <summary>
        /// 修改数据
        /// </summary>
        ...
        {
            return DataFactory.Database().Update(tableName, ht, propertyName, isOpenTrans);
        }
        #endregion
        ...
        {
            return DataFactory.Database().FindTableTop<T>(Top, propertyName, propertyValue);
        }
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        ...
        {
            return DataFactory.Database().FindTable<T>(propertyName, propertyValue);
        }
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        ...
        {
            return DataFactory.Database().FindEntityByWhere<T>(WhereSql, parameters);
        }
        /// <summary>
        /// 查询对象、返回实体
        /// </summary>
        ...
        #region 查询数据列表，不需强制转换搜索条件为小写
        /// <summary>
        ///  查询数据列表、返回 DataTable  不需强制转换搜索条件为小写
        /// </summary>
        /// <param name="strSql"></param>
        /// <param name="isLower">是否需要强制转化搜索条件为小写的标识</param>
        /// <returns></returns>
        public DataTable FindTableBySql(string strSql, bool isLower)
        {
            return DataFactory.Database().FindTableBySql(strSql, isLower);
        }
        #endregion
