...
namespace HfutIE.Repository
{
    ...
    public interface IRepository<T> where T : new()
    {
        ...
        /// <param name="propertyValue">字段值</param>
        /// <returns></returns>
        DataTable FindTableTop(int Top, string propertyName, string propertyValue);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="Top">显示条数</param>
        ...
        /// <param name="propertyValue">字段值</param>
        /// <returns></returns>
        DataTable FindTable(string propertyName, string propertyValue);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="WhereSql">条件</param>
        ...
        /// <summary>
        /// 查询数据列表、返回 DataTable,选择是否强制转换搜索条件为小写 F
        /// </summary>
        /// <param name="strSql"></param>
        /// <param name="isLower">是否强制转换搜索条件为小写的标识</param>
        /// <returns></returns>
        DataTable FindTableBySql(string strSql, bool isLower);
        #endregion
    }
}
