...
namespace HfutIE.Business
{
    ...
    /// </author>
    /// </summary>
    public class BBdbR_QualityCarComponentBaseBll : RepositoryFactory<BBdbR_QualityCarComponentBase>
    {
        #region 全局变量定义区

        //定义本页面主要操作的表的表名，称为主表
        string tableName = "BBdbR_QualityCarComponentBase";//===复制时需要修改===
        public readonly RepositoryFactory<BBdbR_QualityCarComponentBase> repository_User = new RepositoryFactory<BBdbR_QualityCarComponentBase>();
        #endregion
        ...
        public DataTable GetTree()
        {
            ...
            strSql.Append(@"select  CarPositionId AS keys,     
                        ...
                        '0' as parentId,  
                        '0' as sort    
                        from BBdbR_QualityCarPositionBase where Enabled = '1' ");
            strSql.Append(@" union select    
                        ...
                        '1' as sort 
                      from  BBdbR_QualityCarPositionGroupBase a,BBdbR_QualityCarPositionBase b 
                      where a.CarPositionId=b.CarPositionId and a.Enabled = '1' order by code asc");
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Insert(BBdbR_QualityCarComponentBase entity) //===复制时需要修改===
        {
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Update(BBdbR_QualityCarComponentBase entity) //===复制时需要修改===
        {
        ...
        public int Delete(string[] array)
        {
            ...
            List<BBdbR_QualityCarComponentBase> listEntity = new List<BBdbR_QualityCarComponentBase>(); //===复制时需要修改===
            foreach (string keyValue in array)
            {
                //===复制时需要修改===
                BBdbR_QualityCarComponentBase entity = Repository().FindEntity(keyValue);//根据主键（keyValue）在数据库中查找实体 //===复制时需要修改===
