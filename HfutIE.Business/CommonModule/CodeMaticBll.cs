...
namespace HfutIE.Business
{
    ...
    public class CodeMaticBll
    {
        ...
        public XmlNodeList GetTableName()
        {
            ...
            myXmlDocument.Load(DirFileHelper.MapPath("~/Areas/CodeMaticModule/DataModel/HfutIE.Framework.pdm"));
            // 获取表格
        ...
        public string CodeBuilder_Entity(string table, string Key, DataTable Entity_dt)
        {
            ...
            sb_Entity.Append("//=====================================================================================\r\n\r\n");
            sb_Entity.Append("using HfutIE.DataAccess.Attributes;\r\n");
            sb_Entity.Append("using HfutIE.Utilities;\r\n");
        ...
        public string GetCodeBuilderBusiness(string table)
        {
            ...
            sb_Business.Append("//=====================================================================================\r\n\r\n");
            sb_Business.Append("using HfutIE.Entity;\r\n");
            sb_Business.Append("using HfutIE.Repository;\r\n");
            sb_Business.Append("using HfutIE.Utilities;\r\n");
        ...
        public string GetCodeBuilderController(string table)
        {
            ...
            sb_Controller.Append("using HfutIE.Business;\r\n");
            sb_Controller.Append("using HfutIE.Entity;\r\n");
            sb_Controller.Append("using HfutIE.Utilities;\r\n");
            ...
            sb_Controller.Append("namespace HfutIE.WebApp.Areas." + AreasName + ".Controllers\r\n");
