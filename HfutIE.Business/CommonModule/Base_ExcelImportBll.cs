...
namespace HfutIE.Business
{
    ...
    public class Base_ExcelImportBll : RepositoryFactory<Base_ExcelImport>
    {
        ...
        /// <returns></returns>
        public static long GetNextKey(string tablename, string idname)
        {
            long max_key = 0;
            ...
            {
                string value = dt.Rows[0][0] == null ? "" : dt.Rows[0][0].ToString();
                if (value != "")
                {
                    max_key = long.Parse(value);
                    max_key++;
                }
                else
                {
