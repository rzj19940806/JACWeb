...
namespace HfutIE.Business
{
    ...
    /// </author>
    /// </summary>
    public class BFacR_ClassBaseBll : RepositoryFactory<BFacR_ClassBase>
    {
        #region 全局变量定义区
        //定义本页面主要操作的表的表名，称为主表
        ...
        /// <returns></returns>
        public List<BFacR_ClassBase> GetPageListByCondition(string keywords, string Condition, JqGridParam jqgridparam) //===复制时需要修改===
        {
            string sql = "";
            if (Condition == "all")
            {
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Update(BFacR_ClassBase entity) //===复制时需要修改===
        {
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Insert(BFacR_ClassBase entity) //===复制时需要修改===
        {
        ...
        public int Delete(string[] array)
        {
            ...
            List<BFacR_ClassBase> listEntity = new List<BFacR_ClassBase>(); //===复制时需要修改===
            foreach (string keyValue in array)
            {
                //===复制时需要修改===
                BFacR_ClassBase entity = Repository().FindEntity(keyValue);//根据主键（keyValue）在数据库中查找实体 //===复制时需要修改===
