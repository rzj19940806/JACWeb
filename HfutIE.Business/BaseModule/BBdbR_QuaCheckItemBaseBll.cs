...
namespace HfutIE.Business
{
    ...
    public class BBdbR_QuaCheckItemBaseBll : RepositoryFactory<BBdbR_QuaCheckItemBase>
    {
        ...
        //定义本页面主要操作的表的表名，称为主表
        string tableName = "BBdbR_QuaCheckItemBase";//===复制时需要修改===
        ...
        public List<BBdbR_QuaCheckItemBase> GetPageList(JqGridParam jqgridparam) //===复制时需要修改===
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Update(BBdbR_QuaCheckItemBase entity) //===复制时需要修改===
        {
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Insert(BBdbR_QuaCheckItemBase entity) //===复制时需要修改===
        {
        ...
        public int Delete(string[] array)
        {
            ...
            List<BBdbR_QuaCheckItemBase> listEntity = new List<BBdbR_QuaCheckItemBase>(); //===复制时需要修改===
            foreach (string keyValue in array)
            {
                //===复制时需要修改===
                BBdbR_QuaCheckItemBase entity = Repository().FindEntity(keyValue);//根据主键（keyValue）在数据库中查找实体 //===复制时需要修改===
        ...
        public List<BBdbR_QuaCheckItemBase> GetPageListByCondition(string keywords, string Condition, JqGridParam jqgridparam) //===复制时需要修改===
        {
            string sql = "";
        ...
        //    strSql.Append(@"SELECT  * FROM  BBdbR_QuaCheckItemBase where Enabled = '1' and MatCatg = '产品'");
