...
namespace HfutIE.Business
{
    ...
    public class BBdbR_ProductBaseBll : RepositoryFactory<BBdbR_ProductBase>
    {
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Insert(BBdbR_ProductBase entity) //===复制时需要修改===
        {
            //entity.Enabled = "1";
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Update(BBdbR_ProductBase entity) //===复制时需要修改===
        {
        ...
        public int Delete(string[] array)
        {
            ...
            List<BBdbR_ProductBase> listEntity = new List<BBdbR_ProductBase>(); //===复制时需要修改===
            foreach (string keyValue in array)
            {
                //===复制时需要修改===
                BBdbR_ProductBase entity = Repository().FindEntity(keyValue);//根据主键（keyValue）在数据库中查找实体 //===复制时需要修改===
        ...
        public List<BBdbR_ProductBase> GetPageListByCondition(string keywords, string Condition, JqGridParam jqgridparam) //===复制时需要修改===
        {
            string sql = "";
            List<BBdbR_ProductBase> dt;
            if (Condition == "all")
