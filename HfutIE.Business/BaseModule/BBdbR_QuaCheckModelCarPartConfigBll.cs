...
namespace HfutIE.Business
{
    ...
    public class BBdbR_QuaCheckModelCarPartConfigBll : RepositoryFactory<BBdbR_QuaCheckModelCarPartConfig>
    {
        #region 全局变量定义区
        //定义本页面主要操作的表的表名，称为主表
        string tableName = "BBdbR_QuaCheckModelCarPartConfig";//===复制时需要修改===
        #endregion
        #region 1.查询已配置车身部位信息
        /// <summary>
        /// 查询已配置车身部位信息
        /// </summary>
        ...
        //返回值为1，或者0
        //1表示操作成功，0表示操作失败
        public int Insert(BBdbR_CarPartBase entity, string QualityCheckModelId) //===复制时需要修改===
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int Delete(List<BBdbR_QuaCheckModelCarPartConfig> TeamStfList)
        {
            ...
            List<BBdbR_QuaCheckModelCarPartConfig> listEntity = new List<BBdbR_QuaCheckModelCarPartConfig>(); //===复制时需要修改===
