...
namespace HfutIE.Entity
{
    ...
    /// </author>
    /// </summary>
    [Description("关重件绑定过程表")]
    [PrimaryKey("KeyPartsBindProId")]
    public class Q_KeyPartsBind_Pro : BaseEntity
    {
        #region 获取/设置 字段值
        /// <summary>
        /// 关重件绑定过程主键
        /// </summary>
        /// <returns></returns>
        [DisplayName("关重件绑定过程主键")]
        public string KeyPartsBindProId { get; set; }
        /// <summary>
        /// VIN码
        /// </summary>
        /// <returns></returns>
        ...
        {
            KeyPartsBindProId = CommonHelper.GetGuid;
