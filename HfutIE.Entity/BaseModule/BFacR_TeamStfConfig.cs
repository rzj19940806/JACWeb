...
namespace HfutIE.Entity
{
    ...
    /// <author>
    ///		<name>she</name>
    ///		<date>2021.08.28 15:09</date>
    /// </author>
    /// </summary>
    [Description("班组人员配置表")]
    [PrimaryKey("TeamStfId")]
    public class BFacR_TeamStfConfig : BaseEntity
    {
        #region 获取/设置 字段值
        /// <summary>
        /// 主键
        ...
        /// <returns></returns>
        [DisplayName("主键")]
        public string TeamStfId { get; set; }
        /// <summary>
        /// 班组id
        /// </summary>
        /// <returns></returns>
        ...
        {
            this.TeamStfId = CommonHelper.GetGuid;
