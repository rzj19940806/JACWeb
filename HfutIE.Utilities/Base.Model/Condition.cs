...
namespace HfutIE.Utilities
{
    ...
    public class ConditionBuilder
    {
        ...
        public static string GetWhereSql(IList conditions)
        {
            StringBuilder strSql = new StringBuilder();
            foreach (Condition item in conditions)
            {
                string fieldName = item.ParamName;
                object fieldValue = item.ParamValue;
                switch (item.Operation)
                {
                    case ConditionOperate.Equal:
                        strSql.Append(" " + item.Logic);
                        strSql.Append(" " + item.LeftBrace);
                        strSql.Append(fieldName);
                        strSql.Append(" = ");
                        strSql.Append("'" + fieldValue + "'");
                        strSql.Append(" " + item.RightBrace);
                        break;
                    case ConditionOperate.NotEqual:
                        strSql.Append(" " + item.Logic);
                        strSql.Append(" " + item.LeftBrace);
                    ...
                    case ConditionOperate.NotNull:
                        break;
                    case ConditionOperate.Like:
                        //strSql.Append(" " + item.LeftBrace + fieldName + " like " + ParamKey + paramName + item.RightBrace + " " + Logic);
                        break;
                    case ConditionOperate.NotLike:
                        //strSql.Append(" " + item.LeftBrace + fieldName + " not like " + ParamKey + paramName + item.RightBrace + " " + Logic);
                        break;
                    case ConditionOperate.LeftLike:
                        //strSql.Append(" " + item.LeftBrace + fieldName + " like " + ParamKey + paramName + item.RightBrace + " " + Logic);
                        break;
