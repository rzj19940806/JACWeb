//=====================================================================================
// All Rights Reserved , Copyright © HfutIE 2013
//=====================================================================================
using System;
...
namespace HfutIE.Utilities
{
    ...
    public class DateTimeHelper
    {
        ...
        #region 根据某年的某个月获取这个月的起止日期
        public static void MonthRange(int year, int month ,  ref DateTime firstDate, ref DateTime lastDate)
        {
            //当月的第一天
            firstDate = new DateTime(year, month, 1);
            int days =  GetDaysOfMonth(firstDate);
            //当月的最后一天
            lastDate = new DateTime(year, month, days);
        }
        #endregion
        #region 获取某年的第一天和最后一天
        public static void YearRange(int year, int month, ref DateTime firstDate, ref DateTime lastDate)
        {
            //当年的第一天
